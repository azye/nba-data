...
object Q1 {
   ...
   * 
   */
  def per48(statColumn: Int, PlayerName: String, sc: SparkContext) = {
    var yearColumn = 23
    val minutesColumn = 6
    
    
    var players = sc.textFile("Players.txt")
   ...
   * 
   */
  def bestPer48(statColumn: Int, sc: SparkContext) = {
    var yearColumn = 23
    val minutesColumn = 6
   ...
   * 
   */
  def teamPer48(statColumn: Int, team: String, sc: SparkContext) = {
    val yearColumn = 23
    val minutesColumn = 6
    var players = sc.textFile("Players.txt")
   ...
   * 
   */
  def championTeamPer48(statColumn: Int, sc: SparkContext) = {
    var champions = sc.textFile("champions.txt")
    var players = sc.textFile("Players.txt")
   ...
   * 
   */
  def mvpPer48(statColumn: Int, sc: SparkContext) = {
    var mvpPlayers = sc.textFile("mvps.txt")
    var players = sc.textFile("Players.txt")
    var yearColumn = 23
    val minutesColumn = 6
